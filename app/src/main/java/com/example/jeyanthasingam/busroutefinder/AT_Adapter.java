...
/**
 * Created by Jeyanthasingam on 2/25/2017.
 */
...
import com.example.jeyanthasingam.busroutefinder.R;
...
public class AT_Adapter extends RecyclerView.Adapter<AT_Adapter.PredictionHolder> implements Filterable{
    ...
    private ArrayList<PlaceAutocomplete> mResultList;  //imported
    ...
    public void onBindViewHolder(PredictionHolder mPredictionHolder, final int i) {
        mPredictionHolder.mPrediction1.setText(mResultList.get(i).title);
        mPredictionHolder.mPrediction2.setText(mResultList.get(i).txt);
    ...
    public class PredictionHolder extends RecyclerView.ViewHolder {
        private TextView mPrediction1;
        private TextView mPrediction2;
        private RelativeLayout mRow;
        public PredictionHolder(View itemView) {

            super(itemView);
            mPrediction1 = (TextView) itemView.findViewById(R.id.address);
            mPrediction2 = (TextView) itemView.findViewById(R.id.addressSecond);
    ...
    public class PlaceAutocomplete {
        ...
        PlaceAutocomplete(CharSequence placeId, CharSequence title, CharSequence txt) {
